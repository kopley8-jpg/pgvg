...
export const DeviceCard = (props: IDeviceCard) => {
  ...
  return (
    <ObjCard
      ...
      renderForKeys={[
        ...deviceConfig.forKeys(['platforms'], (_key, value) => (
          <></>
        ), { hideKeyName: true }),
        ...deviceConfig.forKeys(["minCoilResistance"], (_key, value) => (
          <TextValue style={{ maxWidth: "120px" }} value={value} {...uiHandler.minCoilResisnatce} />
        )),
        ...deviceConfig.forKeys(['battery'], (_key, value) => (
          <BatteryEntry
            style={ObjEntryStyles(colors)}
            battery={value}
            onError={(e) => { alert(e) }} />
        ), { hideKeyName: true, style: { border: "0px rgba(0,0,0,0), solid" } }),
